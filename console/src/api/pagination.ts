...
export type CursorQuery = NonNullable<
  paths["/v1/organizations"]["get"]["parameters"]["query"]
>;
export type AgentListQuery = NonNullable<
  paths["/v1/agents"]["get"]["parameters"]["query"]
>;
...
export function nextCursor(
  page: { pagination?: { next_cursor?: string | null } } | undefined,
): string | null {
