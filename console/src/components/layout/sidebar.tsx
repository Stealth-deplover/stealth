...
export function Sidebar({ organizationId, projectId, mobile = false }: { organizationId?: string; projectId?: string; mobile?: boolean }) {
  ...
  const orgItems: NavItem[] = organizationId ? [{ label: "Projects", href: `${orgBase}/projects`, icon: FolderKanban }, { label: "Members", href: `${orgBase}/members`, icon: Users }, { label: "Plan & limits", href: `${orgBase}/plan`, icon: Gauge }, { label: "Incidents", href: `${orgBase}/incidents`, icon: Activity }, { label: "Audit", href: `${orgBase}/audit`, icon: ShieldCheck }] : [{ label: "Organizations", href: "/organizations", icon: FolderKanban }];
