  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-colors disabled:pointer-events-none disabled:opacity-45 focus-visible:ring-2 focus-visible:ring-cyan-300/40",
  {
    variants: {
      variant: {
        ...
        secondary: "border border-stealth-border bg-stealth-elevated text-slate-100 hover:bg-white/[0.08]",
        ghost: "text-slate-300 hover:bg-white/[0.06] hover:text-white",
        outline: "border border-stealth-border bg-transparent text-slate-200 hover:border-slate-500 hover:bg-white/[0.04]",
        destructive: "bg-rose-500/90 text-white hover:bg-rose-500",
        subtle: "bg-white/[0.04] text-slate-300 hover:bg-white/[0.08] hover:text-white",
      },
      size: {
        default: "h-9 px-3.5",
