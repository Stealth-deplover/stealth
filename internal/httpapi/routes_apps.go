...
func (s *Server) registerAppRoutes(r chi.Router) {
	...
	r.With(s.requireProjectManagement).Get("/projects/{projectID}/apps/{appID}/diagnostics", s.getAppDiagnostics)
	r.With(s.requireProjectManagement).Get("/projects/{projectID}/apps/{appID}/logs", s.listAppRuntimeLogs)
	r.With(s.requireProjectManagement).Get("/projects/{projectID}/apps/{appID}/variables", s.listAppEnvironmentVariables)
	r.With(s.requireProjectManagement).Post("/projects/{projectID}/apps/{appID}/variables", s.createAppEnvironmentVariable)
	r.With(s.requireProjectManagement).Patch("/projects/{projectID}/apps/{appID}/variables/{variableID}", s.updateAppEnvironmentVariable)
	r.With(s.requireProjectManagement).Delete("/projects/{projectID}/apps/{appID}/variables/{variableID}", s.deleteAppEnvironmentVariable)
	...
	r.With(s.requireProjectManagement).Post("/projects/{projectID}/apps/{appID}/deployments/{deploymentID}/rollback", s.rollbackAppDeployment)
