...
func (s *Server) registerDatabaseRoutes(r chi.Router) {
	...
	r.With(s.requireProjectManagement, s.rateLimitProjectOperation("database_backup")).Post("/projects/{projectID}/databases/{databaseID}/backups", s.createDatabaseBackup)
	...
	r.With(s.requireProjectDataActor, s.rateLimitProjectOperation("database_import")).Post("/projects/{projectID}/databases/{databaseID}/tables/{tableID}/rows/import", s.importDatabaseRows)
	r.With(s.requireProjectDataActor, s.rateLimitProjectOperation("database_transaction")).Post("/projects/{projectID}/databases/{databaseID}/tables/{tableID}/rows/transaction", s.transactDatabaseRows)
